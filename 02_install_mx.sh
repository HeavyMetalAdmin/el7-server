...
mkdir -p /etc/dovecot
mkdir -p /etc/postfix
cat > /usr/local/sbin/adddovecotuser << PASTECONFIGURATIONFILE
#!/bin/sh
if [ ! \$# = 1 ]
 then
...
cat > /usr/local/sbin/deldovecotuser << PASTECONFIGURATIONFILE
#!/bin/bash
#
...
info@i0.vc::5000:5000::/home/vmail/i0.vc/info/:/bin/false::
PASTECONFIGURATIONFILE
...
local_name mx.i0.vc {
	ssl_cert=</etc/letsencrypt/live/mx.i0.vc/fullchain.pem
	ssl_key=</etc/letsencrypt/live/mx.i0.vc/privkey.pem
}
...
info@i0.vc:{CRAM-MD5}e02d374fde0dc75a17a557039a3a5338c7743304777dccd376f332bee68d2cf6
PASTECONFIGURATIONFILE
base64 -d > /etc/postfix/vmaps.db << PASTECONFIGURATIONFILE
AAAAAAEAAAAAAAAAYRUGAAkAAAAAEAAAAAgAAAAAAAACAAAAAAAAAAAAAAAAAAAAAAAAAE3xAQAB
CAAA0lTrq65sAAAAAAAAAQAAAAEAAAAAAAAAAAAAAAMQAADRjWheAQAAAAEAAAAAAAAAAAAAAAAA
...

...

...
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAABZ3J1aG4ubWVk
aWEvbWljaGFlbC8AAW1pY2hhZWxAZ3J1aG4ubWVkaWEA
PASTECONFIGURATIONFILE
...
myhostname = mx.i0.vc
myorigin = \$myhostname
#mydestination = mx.i0.vc, i0.vc, localhost, localhost.localdomain
relayhost =
...
# incoming
smtpd_tls_cert_file = /etc/letsencrypt/live/mx.i0.vc/fullchain.pem
smtpd_tls_key_file = /etc/letsencrypt/live/mx.i0.vc/privkey.pem
...
info@i0.vc	i0.vc/info/
@i0.vc	i0.vc/info/
michael@gruhn.media	gruhn.media/michael/
PASTECONFIGURATIONFILE
