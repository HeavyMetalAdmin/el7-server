...
spammer.cn REJECT
PASTECONFIGURATIONFILE
base64 -d > /etc/postfix/vmaps.db << PASTECONFIGURATIONFILE
AAAAAAEAAAAAAAAAYRUGAAkAAAAAEAAAAAgAAAAAAAACAAAAAAAAAAAAAAAAAAAAAAAAAFV01WMB
/QAAIBt91YI7AAAAAAAAAQAAAAEAAAAAAAAAAAAAAAMQAADRjWheAQAAAAEAAAAAAAAAAAAAAAAA
...

...

bXBsZS5jb20vY2F0Y2hhbGwvAAFAZXhhbXBsZS5jb20A
PASTECONFIGURATIONFILE
base64 -d > /etc/postfix/check_client_access << PASTECONFIGURATIONFILE
PASTECONFIGURATIONFILE
